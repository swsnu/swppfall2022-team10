		...
		<div className='ReviewDetail'>
			<div className='review-images'>
				<Carousel interval={null}>
					{reviewState.selectedReview?.photo_path.map((path: string) => {
						return (
			...
			<div className='post-info' onClick={() => navigate(`/post/${reviewState.selectedReview?.post.id}`)}>
				<div id='post-image'>
					<img src={reviewState.selectedReview?.post.thumbnail} height="100"/>
				</div>
				<div id='post-content'>
					<h6>{reviewState.selectedReview?.post.title}</h6>
					종: [{reviewState.selectedReview?.post.animal_type}] {reviewState.selectedReview?.post.species}
					<br />
