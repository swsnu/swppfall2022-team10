				...
				<div className='InfoContainer'>
					...
					<Card className='text-center'>
						...
						<Card.Body>
							...
							<Card.Text>
								길에서 찾은 유기 동물을 보호 중이세요? 유기 동물
								보호 센터의 동물들을 등록하고 싶으신가요?
							</Card.Text>
							<Button
						...
						<Card.Body>
							...
							<div className='buttons'>
								<Button
									...
									onClick={() =>
										window.open(
											'https://storage.googleapis.com/beafamily-media/dog_form.docx'
										)
									}
								>
									강아지 입양 신청서 다운 받으러 가기
								</Button>
								<Button
									variant='outline-info'
									onClick={() =>
										window.open(
											'https://storage.googleapis.com/beafamily-media/cat_form.docx'
										)
									}
								>
									고양이 입양 신청서 다운 받으러 가기
								</Button>
								<Button
									variant='outline-info'
									onClick={() =>
										window.open(
											'https://storage.googleapis.com/beafamily-media/etc_form.docx'
										)
									}
								>
									그 외 동물 입양 신청서 다운 받으러 가기
								</Button>
							</div>
						</Card.Body>
						<Card.Footer className='text-muted'>
